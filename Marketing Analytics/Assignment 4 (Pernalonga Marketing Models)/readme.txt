...
Peer evaluation (10%)
Reports
The project written report must include:

model diagnostics to justify the validity of the models; and
decomposition of weekly sales volume for each San Miguel product into the following components:
Base (includes Seasonality and Holidays)
Shelf Price
Discount
Flyer
Store Display
